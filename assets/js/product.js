$(document)
    .ready(
        function() {
                    ...
                    function() {
                        ...
                        swal({
                            ...
                            function() {
                                $
                                    .get(
                                        "Product/deactiveProduct?id=" + rowData.id,
                                        function(data,
                                            status) {
                                            if (data.success) {
                                                swal(
                                                    "Deleted!",
                                                    "Berhasil menghapus " + rowData.name + "",
                                                    "success");
                                                table.ajax
                                                    .reload();
                                            } else {
            ...
            $("#modal-new-product-fullscreen #name_new").keyup(function(event) {
                if (event.keyCode == 13) {
                    var id = $("#modal-new-product-fullscreen #product_id").val();
                    var fullName = $("#modal-new-product-fullscreen #name_new").val();
