...
<footer class="footer">
      ...
      <br/>
		...
		<script type="text/javascript" src="<?php echo asset_url() ?>/js/jquery.bootstrap-autohidingnavbar.min.js"></script>
		<script type="text/javascript" src="<?php echo asset_url() ?>/js/navbar-hide-when-scroll-down.js"></script>
