...
<html lang="en">
	<head>
		...
		<link href="<?php echo asset_url() ?>/css/responsive.bootstrap.min.css"	rel="stylesheet">
		<link href="<?php echo asset_url() ?>/css/dataTables.bootstrap.min.css"	rel="stylesheet">
		<link href="<?php echo asset_url() ?>/css/buttons.bootstrap.min.css" rel="stylesheet">
		<link rel="stylesheet" href="<?php echo asset_url() ?>/css/bootstrap-flaty.min.css">
	</head>
	<body>
		<?php
